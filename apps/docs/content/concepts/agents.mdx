...
- a **Model** to run on, picked from one of the Workspace's Providers,
- **Instructions** that shape its personality and behaviour,
- an **Input Placeholder**, shown in the Chat input when the Agent is selected,
...
all of it. [The system prompt](/concepts/system-prompt) lists every part in
order.
