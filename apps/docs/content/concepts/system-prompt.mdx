...
| **11** | **Sandbox**               | When the Agent has the **Sandbox** Tool set                                            | How the [Sandbox](/concepts/sandboxes) works: relative paths from the workspace root, that files persist between turns, that each shell call starts fresh, output limits, how to hand the user a file as a download (where the Sandbox supports it), timeouts, and the _names_ of any Workspace-default environment variables.                             |
