...
* **backend:** added `/chat/tags` endpoint ([62fee2f](https://github.com/willdady/platypus/commit/62fee2ffe2da3faa8071c646f49c5b30b375216d))
...
* **backend:** improved "default" Org and Workspace creation ([9d8afdf](https://github.com/willdady/platypus/commit/9d8afdf6b6f0a37b642538b053465d3bef8be814))
...
* can now renamed Workspace from settings page ([5b266d6](https://github.com/willdady/platypus/commit/5b266d6c5f1d03731a5f739845b0c5a1acedabcb))
...
* **provider:** added Google provider ([ecc5f0f](https://github.com/willdady/platypus/commit/ecc5f0f6e1b21628d02c762ffaa676e7b0a068a7))
...
* **search:** added search toggle ([9365a26](https://github.com/willdady/platypus/commit/9365a268bb8f74947657f79f3980a7529753e25b))
...
* **ui:** accordion on app home page now open by default when there is only 1 Org ([9d80cc3](https://github.com/willdady/platypus/commit/9d80cc335d1f6082fb3e0cc65a39b11425ab5dc7))
* **ui:** add accordion layout to app home page ([cc6cc49](https://github.com/willdady/platypus/commit/cc6cc499d052bf29fd646634d853195a6257a83f))
...
* **ui:** added edit button to agent info dialog ([9b7072f](https://github.com/willdady/platypus/commit/9b7072f90233c36fb555aa0dc82d80d83f3a1ef1))
* **ui:** added global command pallete ([871ff33](https://github.com/willdady/platypus/commit/871ff335947822bb653a19edb47ebbbfe0bd5b91))
...
* **ui:** added separator before footer in AppSidebar ([d157b6a](https://github.com/willdady/platypus/commit/d157b6a85c873bb396a46e2de068ef307dfb5572))
* **ui:** added TagCloud to workspace home page ([8d61ead](https://github.com/willdady/platypus/commit/8d61ead00db7726b5cc98dbc03672b2f3e06df5a))
* **ui:** added workspace home page; removed dedicated agents page ([9b665f0](https://github.com/willdady/platypus/commit/9b665f0ba56e2538e1723bd639889d8355cb0ab1))
* **ui:** AgentInfoDialog now shows provider ([307f3ac](https://github.com/willdady/platypus/commit/307f3ac09997089b3a7a5aefb22314b767537f32))
...
* **ui:** dedicated Back button which goes back in route history ([4509f2a](https://github.com/willdady/platypus/commit/4509f2a7baef795ef29d147101dd71a537c18917))
* **ui:** implement organization management ([02d5f1e](https://github.com/willdady/platypus/commit/02d5f1e23a1585a4ab60354b7f91e906089764be))
...
* **ui:** prompt input now focuses when model selector is closed ([2e4982b](https://github.com/willdady/platypus/commit/2e4982b81beca146cb39e31382afeaf954d8e93b))
* **ui:** updated app Home page ([28c2518](https://github.com/willdady/platypus/commit/28c2518a6e766aad9d156b56a669a93208033025))
* **ui:** updated favicon ([acd9910](https://github.com/willdady/platypus/commit/acd9910e807ce6855e616c1811286db3cb96352c))
...
* **ui:** AgentInfoDialog content padding ([57ee46c](https://github.com/willdady/platypus/commit/57ee46c376405f1e03283c02ef3d967397165568))
* **ui:** AgentList now warns if no Providers are defined before warning about no Agents being defined ([08a69c1](https://github.com/willdady/platypus/commit/08a69c182a78e4776d0fbcd4d21e5dbef2573bda))
* **ui:** AgentsList no longer renders alert when there are 0 agents ([57f3fd0](https://github.com/willdady/platypus/commit/57f3fd09ddca01faffa6ba7c77bb2b508db89e1f))
...
* **ui:** home page is now a client component as fetch failed at build-time ([ca580a6](https://github.com/willdady/platypus/commit/ca580a6f971f0802d3e4db0d1454201d3e0ebb30))
